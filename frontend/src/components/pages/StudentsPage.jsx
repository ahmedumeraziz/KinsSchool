            ...
            <Card className="bg-amber-50 border-amber-200">
              ...
              <ol className="space-y-2 text-sm text-amber-800">
                {[
                  ...
                  !sheetIdSet && 'Add: GOOGLE_SHEET_ID = 1HfCVSyS262WfzKKzhr63sOuyegE-BujsYANrtGyknpA',
                  !scriptSet  && 'Add: GOOGLE_SCRIPT_URL = https://script.google.com/macros/s/AKfycbzag…/exec',
